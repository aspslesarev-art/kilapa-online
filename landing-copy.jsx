...
const COPY = {
  en: {
    ...
    hero: {
      ...
      cta_primary: 'See our apps on the App Store',
      cta_secondary: 'Read the manifesto',
      strip_label: 'Now on the App Store',
    },
    manifesto: {
    ...
    cta: {
      ...
      btn: 'See all apps on the App Store',
    },
    footer: {
  ...
  ru: {
    ...
    hero: {
      ...
      cta_primary: 'Посмотреть в App Store',
      cta_secondary: 'Манифест',
      strip_label: 'Уже в App Store',
    },
    manifesto: {
      eyebrow: 'Зачем мы',
    ...
    cta: {
      ...
      btn: 'Все приложения в App Store',
    },
    footer: {
